...
public class ThongKe {
    ...
    public ArrayList<sachDTO> topSanPhamBanChay;

    public ThongKe() {
    }

    public ThongKe(int soLuongSP, int soLuongKH, int soLuongNV, int[] tongThuQuy, ArrayList<sachDTO> topSanPhamBanChay) {
    ...
    public ArrayList<sachDTO> getTopSanPhamBanChay() {
        return topSanPhamBanChay;
    }

    public void setTopSanPhamBanChay(ArrayList<sachDTO> topSanPhamBanChay) {
        this.topSanPhamBanChay = topSanPhamBanChay;
    }
}
